...
const ArticuloCreatePage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ...
        idMarca: formData.idMarca ? parseInt(formData.idMarca) : undefined,
        precioComSiva: formData.precioComSiva ? parseFloat(formData.precioComSiva) : undefined,
        precioVtaSiva: formData.precioVtaSiva ? parseFloat(formData.precioVtaSiva) : undefined
      };
      
      await obfuscatedApiClient.post('/v1/deposito/articulos', payload);
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              {selectedGrupos.length > 0 && (
                <div className="mb-4">
                  <h4 className="text-sm font-medium text-gray-700 dark:text-slate-300 mb-2">Grupos seleccionados:</h4>
...
export default ArticuloCreatePage; 