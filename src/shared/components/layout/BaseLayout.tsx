            ...
            <button
              ...
              className={`w-full flex items-center justify-between px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 ${
                isActive
                  ...
                  : 'text-gray-700 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-darkmode-700'
              }`}
    ...
    <>
      ...
      <div className="flex h-16 items-center justify-between px-4 bg-gradient-to-r from-primary to-primary/90 shadow-lg">
        <div className="flex items-center">
          ...
          <h1 className="ml-3 text-lg font-bold text-white">Vada Health</h1>
        </div>
        <button
          onClick={() => setSidebarOpen(false)}
          className="text-white/80 hover:text-white lg:hidden p-1 rounded-md hover:bg-white/10 transition-colors"
        >
          <X className="h-6 w-6" />
        </button>
      </div>
      ...
      <div className="p-4 border-b border-gray-200 dark:border-darkmode-400 bg-gray-50 dark:bg-darkmode-700">
        <div className="flex items-center space-x-3">
          <div className="w-12 h-12 bg-gradient-to-br from-primary/20 to-primary/10 dark:from-primary/30 dark:to-primary/20 rounded-full flex items-center justify-center border-2 border-primary/20">
      ...
      <div className="p-4 border-t border-gray-200 dark:border-darkmode-400 bg-gray-50 dark:bg-darkmode-700">
        <Button
          ...
          className="w-full justify-center hover:bg-red-50 hover:text-red-600 hover:border-red-200 dark:hover:bg-red-900/20 dark:hover:text-red-400 dark:hover:border-red-800 transition-colors"
        >
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-darkmode-800">
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="relative flex w-80 flex-col bg-white dark:bg-darkmode-600 shadow-2xl h-full">
          {sidebarContent}
        </div>
      </div>
          ...
          <div className="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
            <div className="flex items-center">
              <button
                ...
                className="text-gray-500 hover:text-gray-600 dark:text-gray-400 dark:hover:text-gray-300 lg:hidden p-2 rounded-md hover:bg-gray-100 dark:hover:bg-darkmode-700 transition-colors"
              >
            ...
            <div className="flex items-center space-x-4">
              <div className="hidden md:flex items-center space-x-2 px-3 py-1.5 bg-gray-100 dark:bg-darkmode-700 rounded-lg">
                {getRoleIcon(user?.role.name || '')}
